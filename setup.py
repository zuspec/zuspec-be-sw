...
zuspec_be_sw_dir = os.path.dirname(os.path.abspath(__file__))

if os.path.isdir(os.path.join(zuspec_be_sw_dir, "packages")):
    print("Packages are inside this directory")
    packages_dir = os.path.join(zuspec_be_sw_dir, "packages")
else:
    parent = os.path.dirname(zuspec_be_sw_dir)
...
ext = Extension("zsp_be_sw.core",
            ...
            sources=[
                os.path.join(zuspec_be_sw_dir, 'python', "core.pyx"), 
            ],
            language="c++",
            include_dirs=[
