...
class GeneratorFunctionsThreaded : public virtual IGeneratorFunctions {
public:
    GeneratorFunctionsThreaded();

    virtual ~GeneratorFunctionsThreaded();
