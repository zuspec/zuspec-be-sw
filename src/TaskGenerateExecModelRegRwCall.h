/**
 * TaskGenerateExecModelRegRwCall.h
 *
...
class TaskGenerateExecModelRegRwCall :
    public virtual TaskGenerateExecModelCustomGenBase {
public:
    TaskGenerateExecModelRegRwCall(dmgr::IDebugMgr *dmgr);

    virtual ~TaskGenerateExecModelRegRwCall();
