...
#****************************************************************************
"""
Performance benchmark for RV64I Transfer-Function Level Model

This script measures the instruction throughput (instructions per second)
of the RV64I model under various workloads to assess model performance.

Based on: packages/zuspec-dataclasses/examples/rv64/xf/benchmark_rv64_xf.py
"""
...
sys.path.insert(0, str(REPO_ROOT / "packages" / "zuspec-dataclasses" / "examples" / "rv64" / "xf"))
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Benchmark RV64I transfer-function model performance"
    )
    parser.add_argument(
        "--iterations",
        type=int,
